          ...
          <div class="right-section">
            ...
            <div  class="mb-4 display-block " >
              <div  class="mb-2 display-block" >
                <p class="description"> Business name generator & domain Name Generator</p>
              </div>
              <div  class="mb-2 display-block" >
                <p class="description">Use it to come with cool name for your business or little side project</p>
              </div>
              <div  class="mb-2 display-block"  >
                <p class="description">Or use it to brainstorm some good business & brand name ideas. It could be also used to merge the words and names you typed</p>
              </div>
            </div>
            <div class="mb-2 display-block" >
              <p class="sub-description">Type one or more words in one of the boxes, then choose to add prefixes or suffixes then press.
